          ...
          <div className={styles.experienceContainer}>
            <div className={styles.experienceText}>
              ...
              <p className={styles.experienceDesc}>
                Whether you're a day trader, swing trader, scalper, or long-term investor, cTrader
                provides the flexibility, speed, and professional tools needed to trade confidently
          ...
          <div className={styles.advantagesContainer}>
            ...
            <div className={styles.advantagesGrid}>
              ...
              <div className={`${styles.advantageCard} adv-card`}>
                ...
                <p className={styles.advantageDesc}>
                  Access integrated market analysis, watchlists, advanced order types, and risk
                  management.
                </p>
              </div>
            </div>
        ...
        <section className={styles.ctaSection}>
          ...
          <div className={styles.ctaContainer}>
            ...
            <p className={styles.ctaDesc}>
              Open your APFX trading account and unlock the complete cTrader ecosystem with
