...
/* =========================================================
   Types — mirror the server-side ARTICLE_META shape
   ========================================================= */
...
function DefaultBody({ slug }: { slug: string }) {
  return (
    <>
      <p>
        This is a placeholder for the article &ldquo;{slug}&rdquo;. In production,
        content would be loaded from a CMS or markdown.
      </p>
      <h2>Key takeaways</h2>
      <ul>
      ...
      <p>
        Our risk management tools help you calculate risk per trade, see how much
        return you need to recover from a drawdown, and estimate the probability of
        ruin given your win rate and reward-to-risk ratio.
      </p>
      <ArticleCallout tool="pip" />
      <ArticleCallout
        tool="position-size"
        message="Try our Position Size Calculator to size your trades based on your account balance and risk per trade."
      />
      <div className={styles.ctaBlock}>
        ...
        <div className={styles.ctaBlockLinks}>
          ...
          <Link href="/tools/risk-management/risk-per-trade">Risk Management Tools</Link>
        </div>
      </div>
    </>
  )
