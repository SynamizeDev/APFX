...
const ANNOUNCEMENTS = [
  ...
  { title: 'Expanded Educational Content', description: 'New blog series and glossary entries to support traders at every level.', date: '2025-02-01', url: '/learn/courses' },
]
