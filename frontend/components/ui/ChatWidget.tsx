...
export default function ChatWidget() {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([{ id: 'msg-0', text: INITIAL_GREETING, sender: 'bot', options: MAIN_OPTIONS }])
    }
  ...
  const handleOptionSelect = (option: string) => {
    ...
    setMessages((prev) => [...prev, { id: `msg-${Date.now()}-user`, text: option, sender: 'user' }])

    // Then process response based on option
    switch (option) {
      /* ── Main Menu ── */
      case 'Account Types':
        appendBotMessage('APFX offers two account types designed for different traders.', [
          'Standard Account',
          'Premium Account',
        ])
        break
      ...
      case 'Deposits & Withdrawals':
        ...
        break
      case 'Spreads & Fees':
        appendBotMessage('APFX offers competitive spreads with institutional liquidity.', [
          'Standard Spreads',
          'Premium Spreads',
          'Trading Commission',
          'Back to Menu',
      ...
      case 'Verification (KYC)':
        appendBotMessage('To activate your account you must complete identity verification.', [
          'Required Documents',
          'Verification Time',
          'Upload Documents',
          'Back to Menu',
      ...
      case 'Promotions & Rebates':
        appendBotMessage('High-volume traders can qualify for volume rebates and custom pricing.', [
          'Volume Rebates',
          'VIP Program',
          'Partner Program',
          'Back to Menu',
      ...
      case 'Contact Support':
        appendBotMessage('You can contact the APFX support team directly.', [
          'Email Support',
          'Live Agent',
          'Schedule Call',
          'Back to Menu',
      ...
      case 'Web Terminal':
        appendBotMessage(
          'Web Terminal\n\nTrade directly from your browser with advanced charting and one-click trading.',
          ['Back to Menu']
        )
        break
      case 'cTrader':
      ...
      default:
        // Catch all fallback
        appendBotMessage(
          "I can certainly help with that. Is there anything else you'd like to explore?",
